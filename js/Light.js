...
Material.prototype.Gold = function()
{
    this.ambient = new Vector3(0.24725, 0.1995, 0.0745);
    this.diffuse = new Vector3(0.75164, 0.60648, 0.22648);
    this.specular = new Vector3(0.628281, 0.555802, 0.366065);
    this.shine = 0.4;
    return this;
};

Material.prototype.BlackRubber = function()
{
    this.ambient.set(0.02, 0.02, 0.02);
    this.diffuse.set(0.01, 0.01, 0.01);
    this.specular.set(0.4, 0.4, 0.4);
    this.shine = 0.078125;
    return this;
};

Material.prototype.Obsidian = function()
{
    this.ambient.set(0.05375, 0.05, 0.06625);
    this.diffuse.set(0.18275, 0.17, 0.22525);
    this.specular.set(0.332741, 0.328634, 0.346435);
    this.shine = 0.3;
    return this;
};

Material.prototype.Chrome = function()
{
    this.ambient.set(0.25, 0.25, 0.25);
    this.diffuse.set(0.4, 0.4, 0.4);
    this.specular.set(0.774597, 0.774597, 0.774597);
    this.shine = 0.6;
    return this;
};
